...
class AuthService {
  ...
  Future SignUp(
      String mail, String pass, String username, BuildContext context) async {
    try {
      ...
      switch (e.code) {
        case "email-already-in-use":
          return Fluttertoast.showToast(
            msg:
                "Bu email adresine kayıtlı bir kullanıcı zaten var.", // message
            toastLength: Toast.LENGTH_SHORT, // length
            gravity: ToastGravity.BOTTOM, // location
          );
        case "invalid-email":
  ...
  Future ResetPasswordOnApp(String mail, BuildContext context) async {
    try {
      await _auth.sendPasswordResetEmail(email: mail);
      Fluttertoast.showToast(msg: "Sıfırlama maili gönderildi.");
    } on FirebaseAuthException catch (e) {
