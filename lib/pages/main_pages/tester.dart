...
void main() => runApp(LeaderboardScreen1());

class LeaderboardScreen1 extends StatefulWidget {
  @override
  State<LeaderboardScreen1> createState() => _LeaderboardScreen1State();
}

class _LeaderboardScreen1State extends State<LeaderboardScreen1> {
