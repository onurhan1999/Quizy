...
class _QuizScreen1State extends State<QuizScreen1> {
  ...
  Widget build(BuildContext contexte) {
    print(contexte.contextHeight());
    print(contexte.contextWidth());
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: Container(
                              ...
                              decoration: DecorationProperties.questionBackgroundDecoration,
                              child: Padding(
                          ...
                          Padding(
                            padding:  EdgeInsets.only(top: isBigScreen()?10:5),
                            child: Card(
                          ...
                          SizedBox(height: isBigScreen() ? context.dynamicHeight(0.055): context.dynamicHeight(0.020)),
                          continueButtonState
                              ? Card(
